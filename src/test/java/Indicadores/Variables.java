...
public class Variables {
    ...
    public static final String DocumentoIngreso = "CARTA PORTE CFDI - INGRESO"; // Número de documento de traslado
    public static final String DocumentoTraslado = "CARTA PORTE CFDI - TRASLADO"; // Número de documento de traslado
    public static final String Operador = "6"; // Número de operador/*024518*/
