...
public class PostulacionTransportista {
    ...
    public void setup() {
        ...
        options.addArguments(
                ...
                "--headless" // o "--headless=new" para versiones modernas de Chrome
        );
    ...
    public void BuscarSubasta() throws Exception {
        // ——— Espera hasta 30 segundos a que cargue un elemento clave de la página ———
        WebDriverWait waitCargaInicial = new WebDriverWait(driver, Duration.ofSeconds(30));
        waitCargaInicial.until(ExpectedConditions.visibilityOfElementLocated(
                By.xpath("//input[@placeholder='Buscar']")  // o cualquier otro elemento clave que garantice que la página ya cargó
        ));
        // ———————————————————————————————————————————————————————————————————————
    ...
    public void CheckAutorizacion() {
        By by = By.cssSelector("input[name='aceptarCondicion']");
        try {
