...
public class PagoFacturaViaje {
    ...
    private static void AceptarFactura() {
        try {
            ...
            System.err.println("Error al presionar el botón de aceptar factura.");
        }
    }
    ...
    private static void AceptarTimbre() {
        try {
            // Inicialización de WebDriverWait con un timeout de 10 segundos
            //WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(2));

            // Espera explícita hasta que el botón de aceptar timbre sea clicable usando el XPath proporcionado
            ...
            // Hacer clic en el botón de aceptar timbre
    ...
    @Step("Enviar Comprobante de Pago por Correo")
    public void EnvioCorreoFactura() {
        try {
            WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(3));
            // Definir los XPaths de los dos elementos
            String xpath1 = "/html/body/form/table/tbody/tr/td/table/tbody/tr/td/div/table/tbody/tr[2]/td/div[1]/table/tbody/tr/td/div/div[3]/table/tbody/tr/td/table/tbody/tr[2]/td/div[2]/table/tbody/tr/td/input";
